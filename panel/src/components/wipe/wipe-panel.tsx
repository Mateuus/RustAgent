    ...
    <div className="space-y-4">
      ...
      <div role="tabpanel" aria-labelledby={`wipe-tab-${tab}`} className="space-y-4">
        ...
        {/* ####  OS QUATRO PONTOS DE MONTAGEM  ####
            ...
            mais nada deste arquivo. */}

        {tab === 'mapas' && <EmConstrucao tab="mapas" />}
...
const EM_CONSTRUCAO: Readonly<
  Record<
    Exclude<WipeTab, 'geral' | 'agenda'>,
    { readonly title: string; readonly detail: string }
  >
> = {
  mapas: {
    title: 'A fila de mapas ainda está sendo construída.',
    detail:
      'Ela vai responder qual mundo entra no lugar: colar uma seed, sortear, reordenar a fila e ver a prévia do mapa. Enquanto ela não entra, fila vazia significa que o agente sorteia na hora do wipe — nenhum wipe fica travado esperando curadoria.',
  },
  blueprints: {
